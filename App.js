...
async function showMovies(pageNumber = 1, sort_by = "desc") {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkNTEwMzIzMDM5OTU5YWIwZDU4YWVjNmNiNjljNGQ4ZCIsInN1YiI6IjY0ZDkwYzY0Yjc3ZDRiMDBhYzVjNDIyMiIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.x1wEq_oTjDT7RhJ6hqRDtHeV2vLIEjErIYMb5X0WawQ'
    }
  };
  ...
  response = await  fetch(`https://api.themoviedb.org/3/discover/movie?include_adult=false&include_video=false&language=en-US&page=${pageNumber}&sort_by=${
